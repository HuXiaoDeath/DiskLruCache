...
public class DiskLruCacheHelper {
    ...
    public static DiskLruCacheHelper mDiskHelpInstnce;

    private DiskLruCacheHelper(){

    }

    public static DiskLruCacheHelper getDiskHelpInstnce(Context context){

        if(mDiskHelpInstnce == null){
            synchronized (DiskLruCacheHelper.class){
                if(mDiskHelpInstnce == null){
                    mDiskHelpInstnce = new DiskLruCacheHelper(context);
                }
            }
        }
        return mDiskHelpInstnce;
    }
    ...
    private DiskLruCache generateCache(Context context, String dirName, int maxCount)
    {
        ...
        try {
            diskLruCache = DiskLruCache.open(
                    ...
                    DiskLurUtils.getAppVersion(context),
                    DEFAULT_VALUE_COUNT,
                    maxCount);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public String getAsString(String key) {
        ...
        String str = null;
        try {
            str = DiskLurUtils.readFully(new InputStreamReader(inputStream, DiskLurUtils.UTF_8));
        } catch (IOException e) {
            e.printStackTrace();
            try {
                inputStream.close();
    ...
    {
        put(key, DiskLurUtils.bitmap2Bytes(bitmap));
    }
    ...
    public Bitmap getAsBitmap(String key)
    {
        ...
        return DiskLurUtils.bytes2Bitmap(bytes);
    }
    ...
    {
        put(key, DiskLurUtils.drawable2Bitmap(value));
    }
    ...
    public Drawable getAsDrawable(String key)
    {
        ...
        return DiskLurUtils.bitmap2Drawable(DiskLurUtils.bytes2Bitmap(bytes));
    }
    ...
    public boolean remove(String key)
    {
        try
        {
            key = DiskLurUtils.hashKeyForDisk(key);
    ...
    public InputStream get(String key)
    {
        try
        {
            DiskLruCache.Snapshot snapshot = mDiskLruCache.get(DiskLurUtils.hashKeyForDisk(key));
